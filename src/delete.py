...
# MODEL_NAME = "atla/selene-mini:latest"
...
# ────────────────────────────────────────────────
#  MAIN - only the 6 requested symbols
# ────────────────────────────────────────────────

async def main_async():
    RESULTS_DIR.mkdir(parents=True, exist_ok=True)

    # Only these exact files will be processed
    requested_paths = [
        "/home/nckh2/qa/SLM/data/PFE_1d_full.csv",
        "/home/nckh2/qa/SLM/data/SCHW_1d_full.csv",
        "/home/nckh2/qa/SLM/data/SPGI_1d_full.csv",
        "/home/nckh2/qa/SLM/data/TMO_1d_full.csv",
        "/home/nckh2/qa/SLM/data/WFC_1d_full.csv",
        "/home/nckh2/qa/SLM/data/UNH_1d_full.csv",
    ]
    ...
    if not data_files:
        print("None of the requested CSV files were found.")
        return

    symbols = [p.stem.split('_')[0] for p in data_files]
    print(f"Found and will process {len(data_files)} symbols: {', '.join(symbols)}\n")
